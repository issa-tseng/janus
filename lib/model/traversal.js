...
(function() {
  var Traversal, cases, cases2, deepSet, defcase, defer, delegate, extendNew, fn, from, get, identity, isFunction, isParentValueParent, k, kase, match, matcher, nothing, processNode, recurse, ref, ref1, ref2, value, varying, withContext, x,
    slice = [].slice;
  ...
  Traversal = {
    ...
    getNatural: function(obj, map, context) {
      var attribute, i, key, len, local, ref3, result, set;
      if (context == null) {
        context = {};
      }
