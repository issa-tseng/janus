...
(function() {
  var Base, Varying, View, app, attribute, dynamic, get, isFunction, isString, match, ref, ref1, resolve, self, varying,
  ...
  ref = require('../core/types').from, dynamic = ref.dynamic, get = ref.get, resolve = ref.resolve, attribute = ref.attribute, varying = ref.varying, app = ref.app, self = ref.self;
    ...
    View.prototype.pointer = function() {
      return this.pointer$ != null ? this.pointer$ : this.pointer$ = match(dynamic((function(_this) {
        return function(x) {
          ...
          } else if (isString(x) && (_this.subject.get != null)) {
