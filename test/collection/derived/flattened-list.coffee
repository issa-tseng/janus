...
describe 'collection', ->
  describe 'flattened list', ->
    ...
    it 'should handle additions to the original list', ->
      ...
      ol.at_(2).add(4.5) # [ 1 2 [ 3 4 4.5 ] 5 [ 6 ] ]
      fl.length_.should.equal(7)
      for elem, idx in [ 1, 2, 3, 4, 4.5, 5, 6 ]
        fl.at_(idx).should.equal(elem)

      ol.add(5.5, 4) # [ 1 2 [ 3 4 4.5 ] 5 5.5 [ 6 ] ]
      fl.length_.should.equal(8)
    ...
    it 'should handle removals from the original list', ->
      ...
      ol.at_(2).removeAt(0) # [ 1 2 [ 4 ] 5 [ 6 ] ]
      fl.length_.should.equal(5)
      for elem, idx in [ 1, 2, 4, 5, 6 ]
        fl.at_(idx).should.equal(elem)

      ol.at_(2).removeAt(0) # [ 1 2 [] 5 [ 6 ] ]
      fl.length_.should.equal(4)
      for elem, idx in [ 1, 2, 5, 6 ]
        fl.at_(idx).should.equal(elem)

      ol.removeAt(3) # [ 1 2 [] [ 6 ] ]
      fl.length_.should.equal(3)
    ...
    it 'should handle new lists in the original list', ->
      ...
      ol.at_(3).add('z', 1) # [ 1 2 [ 3 4 ] [ a z b ] 5 [ 6 ] ]
      fl.length_.should.equal(9)
