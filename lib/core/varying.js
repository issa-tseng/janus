...
(function() {
  var ComposedVarying, FlatMappedVarying, FlattenedVarying, ManagedVarying, MappedVarying, Observation, UnreducedComposedVarying, Varying, fix, identity, isFunction, nothing, ref, uniqueId,
    slice = [].slice,
  ...
  Varying = (function() {
    ...
    Varying.all = function(vs) {
      return new UnreducedComposedVarying(vs);
    };
  ...
  FlatMappedVarying = (function(superClass) {
    ...
    FlatMappedVarying.prototype.react = function(x, y) {
      if (x === false) {
        return this._react(y, false);
      } else if (x === true) {
        return this._react(y, true);
      } else {
        return this._react(x, true);
      }
    };
    ...
    FlatMappedVarying.prototype._bind = function() {
      return this._parent.react(false, (function(_this) {
        return function(raw) {
  ...
  ComposedVarying = (function(superClass) {
    ...
    ComposedVarying.prototype._bind = function() {
      var a, idx, o, parentObservations;
      parentObservations = (function() {
          ...
          results.push((function(_this) {
            return function(a, idx) {
              return a.react(function(value) {
                ...
                if (_this._bound === true) {
                  _this._onValue(_this._parentObservation, _this._f.apply(null, _this._partial));
                }
              });
            };
          })(this)(a, idx));
      ...
      this._bound = true;
      o = new Observation(this, uniqueId(), null, (function(_this) {
        return function() {
          var i, len, results;
          results = [];
          for (i = 0, len = parentObservations.length; i < len; i++) {
            o = parentObservations[i];
            results.push(o.stop());
          }
          return results;
        };
  ...
  UnreducedComposedVarying = (function(superClass) {
    extend(UnreducedComposedVarying, superClass);

    function UnreducedComposedVarying(_applicants) {
      this._applicants = _applicants;
      this._observers = {};
      this._refCount = 0;
      this._value = nothing;
    ...
    UnreducedComposedVarying.prototype.map = function(f) {
      return new ComposedVarying(this._applicants, f);
    };

    UnreducedComposedVarying.prototype.flatMap = function(f) {
      return new ComposedVarying(this._applicants, f, true);
    };

    UnreducedComposedVarying.prototype.flatten = void 0;

    UnreducedComposedVarying.prototype._bind = function() {
      var a, bound, idx, o, parentObservations, partial;
      bound = false;
      partial = [];
      parentObservations = (function() {
        var i, len, ref1, results;
          ...
          results.push((function(_this) {
            return function(a, idx) {
              return a.react(function(value) {
                partial[idx] = value;
                if (bound === true) {
                  _this._onValue(_this._parentObservation, partial);
                }
              });
            };
          })(this)(a, idx));
    ...
    UnreducedComposedVarying.prototype._onValue = function(observation, value, silent) {
      var _, generation, o, ref1;
      if (silent == null) {
        silent = false;
      }
      if (silent === true) {
    ...
    UnreducedComposedVarying.prototype._immediate = function() {
    ...
    return UnreducedComposedVarying;
