...
(function() {
  var ComposedVarying, FlatMappedVarying, FlattenedVarying, ManagedVarying, MappedVarying, Observation, UnreducedComposedVarying, Varying, fix, identity, isFunction, noop, nothing, ref, uniqueId,
    slice = [].slice,
