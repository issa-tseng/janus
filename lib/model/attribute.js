...
(function() {
  var Attribute, BooleanAttribute, CollectionAttribute, DateAttribute, EnumAttribute, List, Map, Model, ModelAttribute, NumberAttribute, ReferenceAttribute, TextAttribute, Varying, from, types,
      ...
      this.reactTo(this.model.watch(this.key).refCount(), (function(_this) {
        return function(count) {
          ...
          if (count === 0 && (observation != null)) {
            ...
            result = request.isRequest === true ? app.resolve(request) : request.all != null ? request.all.point(_this.model.pointer()).flatMap(function(request) {
