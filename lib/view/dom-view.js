...
(function() {
  var DomView, List, Varying, View, app, attribute, dynamic, isFunction, isString, match, resolve, self, varying, watch, _ref, _ref1,
  ...
  _ref = require('../core/from')["default"], dynamic = _ref.dynamic, watch = _ref.watch, resolve = _ref.resolve, attribute = _ref.attribute, varying = _ref.varying, app = _ref.app, self = _ref.self;

  View = require('./view').View;

  List = require('../collection/list').List;

  _ref1 = require('../util/util'), isFunction = _ref1.isFunction, isString = _ref1.isString;
