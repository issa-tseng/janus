...
(function() {
  ...
  processRoot = function(general, process) {
    var ref3;
    return fix(function(matchRootAction) {
      return match(recurse(function(into, context) {
    ...
    })(((ref3 = general.recurse) != null ? ref3 : recurse)(general.obj, general.context));
  };
  ...
  Traversal = {
    natural: function(obj, fs, context) {
      var fmapper, general;
      if (context == null) {
        context = {};
      }
    ...
    list: function(obj, fs, context) {
      ...
      return processRoot(general, reducer(general, function() {
        return function() {
          return general.obj.enumerate().flatMapPairs(fmapper);
        };
      }));
    },
    natural_: function(obj, fs, context) {
    ...
    diff: {
      recurse: function(obj, arg) {
        ...
        if (((obj != null ? obj.isEnumerable : void 0) === true && (other != null ? other.isEnumerable : void 0) === true) && (obj.isMappable === other.isMappable)) {
          return varying(Varying.mapAll(obj.length, other.length, function(la, lb) {
            if (la !== lb) {
              return value(true);
            } else {
              return recurse(obj, {
      ...
      map: function(k, va, obj, attribute, arg) {
        var other;
        other = arg.other;
        return varying(other.get(k).map(function(vb) {
          if ((va != null) && (vb != null)) {
