(function() {
  var Base, CompleteState, CreateRequest, DeleteRequest, ErrorState, FetchRequest, MemoryCacheStore, Model, OnPageCacheStore, OneOfStore, PendingState, ProgressState, Request, RequestState, ServiceErrorState, Store, SuccessState, UpdateRequest, UserErrorState, Varying, util, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  ProgressState = (function(_super) {
    ...
    function ProgressState(progress, code) {
      this.progress = progress;
      this.code = code != null ? code : 202;
    }
  ...
  CompleteState = (function(_super) {
    ...
    function CompleteState(result, code) {
      this.result = result;
  ...
  SuccessState = (function(_super) {
    ...
    function SuccessState(result, code) {
      this.result = result;
  ...
  ErrorState = (function(_super) {
    ...
    function ErrorState(error, code) {
      this.error = error;
      this.code = code;
    }
  ...
  UserErrorState = (function(_super) {
    ...
    function UserErrorState() {
      _ref1 = UserErrorState.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  ServiceErrorState = (function(_super) {
    ...
    function ServiceErrorState() {
      _ref2 = ServiceErrorState.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  FetchRequest = (function(_super) {
    ...
    function FetchRequest() {
      _ref3 = FetchRequest.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  CreateRequest = (function(_super) {
    ...
    function CreateRequest() {
      _ref4 = CreateRequest.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  UpdateRequest = (function(_super) {
    ...
    function UpdateRequest() {
      _ref5 = UpdateRequest.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  DeleteRequest = (function(_super) {
    ...
    function DeleteRequest() {
      _ref6 = DeleteRequest.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  OneOfStore = (function(_super) {
    ...
    function OneOfStore() {
      _ref7 = OneOfStore.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
    ...
    OneOfStore.prototype._handler = function(request) {
      var handled, handler, _i, _len, _ref8;

      handled = Store.Unhandled;
      _ref8 = this.constructor.handlers;
  ...
  MemoryCacheStore = (function(_super) {
    ...
    function MemoryCacheStore() {
      _ref8 = MemoryCacheStore.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  OnPageCacheStore = (function(_super) {
    ...
    function OnPageCacheStore() {
      _ref9 = OnPageCacheStore.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
