...
(function() {
  ...
  Library = (function(superClass) {
    ...
    Library.prototype.get = function(obj, options) {
      ...
      book = (ref = this._get(obj, obj.constructor, (ref1 = options.context) != null ? ref1 : this._defaultContext, options)) != null ? ref : this._get(obj, obj.constructor, 'default', options);
      if (book != null) {
    ...
    Library.prototype._get = function(obj, klass, context, options) {
      ...
      bookId = obj["case"] != null ? "case@" + obj["case"].namespace + "." + obj.type : obj.isCase === true ? "case@" + obj.namespace + "." + obj.type : util.isNumber(obj) ? 'number' : util.isString(obj) ? 'string' : obj === true || obj === false ? 'boolean' : Library._classId(klass);
