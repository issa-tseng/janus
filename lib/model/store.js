(function() {
  var Base, CompleteState, CreateRequest, DeleteRequest, ErrorState, FetchRequest, MemoryCacheStore, Model, OnPageCacheStore, OneOfStore, PendingState, ProgressState, Request, RequestState, ServiceErrorState, Store, SuccessState, UpdateRequest, UserErrorState, Varying, util, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
  ...
  OneOfStore = (function(_super) {
    ...
    OneOfStore.prototype._handle = function() {
      var handled, maybeStore, _i, _len, _ref7;

      handled = Store.Unhandled;
      _ref7 = this.maybeStores;
  ...
  MemoryCacheStore = (function(_super) {
    ...
    MemoryCacheStore.prototype._cache = function() {
      ...
      return (_ref7 = this._cache$) != null ? _ref7 : this._cache$ = {};
    };
