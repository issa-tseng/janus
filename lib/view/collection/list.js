(function() {
  ...
  ListView = (function(_super) {
    ...
    ListView.prototype._getView = function(item) {
      ...
      view = item == null ? null : item instanceof DomView ? (this._subviews.add(item), item) : this.options.itemView != null ? (result = new this.options.itemView(item, util.extendNew(this.options.childOpts, {
        app: this.options.app
      })), this._subviews.add(result), result) : this._app().getView(item, {
