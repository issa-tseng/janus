...
(function() {
  var DomView, List, Varying, View, app, attr, definition, dynamic, extend, extendNew, isFunction, isString, match, varying, _ref, _ref1,
  ...
  _ref = require('../core/from')["default"], dynamic = _ref.dynamic, attr = _ref.attr, definition = _ref.definition, varying = _ref.varying, app = _ref.app;
  ...
  DomView = (function(_super) {
    ...
    }), attr(function(x, view) {
      return view.subject.resolve(x, view._app());
    }), definition(function(x, view) {
