...
(function() {
  ...
  ListView = (function(superClass) {
    ...
    _insert = function(dom, list, it, idx) {
      var binding, iter, length;
      length = list.length;
      if ((1 + idx) === length) {
        return dom.append(it.dom);
      }
      iter = 0;
      while ((++iter + idx) < length) {
        if ((binding = list[iter + idx]) != null) {
    ...
    ListView.prototype._hookBindings = function(dom, bindings) {
      ...
      this.listenTo(bindings, 'moved', (function(_this) {
        return function(binding, idx) {
          return _insert(dom, bindings.list, binding, idx);
        };
      })(this));
    ...
    ListView.prototype.subviews = function() {
      if (this._mappedBindings == null) {
        return new List();
      }
      return this._mappedBindings.flatMap(function(binding) {
    ...
    ListView.prototype.subviews_ = function() {
      var binding, i, len, ref1, results, subview;
      if (this._mappedBindings == null) {
        return [];
      }
      ref1 = this._mappedBindings.list;
      ...
      for (i = 0, len = ref1.length; i < len; i++) {
        binding = ref1[i];
        if ((subview = binding.parent.get()) != null) {
