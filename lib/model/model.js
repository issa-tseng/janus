  ...
  Model = (function(_super) {
    ...
    function Model(attributes, options) {
      ...
      this._binders = (function() {
        ...
        _ref1 = this.constructor.binders();
        _results = [];
    ...
    Model.prototype.get = function(key) {
      ...
      if (value == null) {
        ...
        if (value instanceof require('../collection/list').List) {
    ...
    Model.attributes = function() {
      ...
      return (_ref1 = this._attributes) != null ? _ref1 : this._attributes = {};
    };
    ...
    Model.prototype.attribute = function(key) {
      ...
      return (_ref1 = (_base = this._attributes)[key]) != null ? _ref1 : _base[key] = typeof (_base1 = (this.constructor.attributes()[key])) === "function" ? new _base1(this, key) : void 0;
    };
    ...
    Model.binders = function() {
      ...
      return (_ref1 = this._binders) != null ? _ref1 : this._binders = [];
    };
    ...
    Model.serialize = function(model, opts) {
      ...
      walkAttrs = function(keys, src, target) {
        ...
        for (subKey in src) {
          ...
          result = value === Null ? void 0 : (attribute != null) && (attribute.serialize != null) ? attribute.serialize(opts) : util.isPlainObject(value) ? (result = {}, walkAttrs(thisKey, value, result), util.hasProperties(result) ? result : void 0) : value;
      ...
      result = model._parent != null ? this.serialize(model._parent, opts) : {};
