...
(function() {
  var AnyFold, Base, Enumerable, IncludesFold, IndexOfFold, Mappable, MinMaxFold, Sequence, SumFold, Traversal, Varying, folds,
  ...
  Enumerable = (function(superClass) {
    ...
    Enumerable.prototype.enumerate_ = function() {
      return (Enumeration$ != null ? Enumeration$ : Enumeration$ = require('./enumeration').Enumeration).get_(this);
    };
    ...
    Enumerable.prototype.enumerate = function() {
      ...
      return (this.enumerate$ != null ? this.enumerate$ : this.enumerate$ = Base.managed((function(_this) {
        return function() {
  ...
  Sequence = (function(superClass) {
    ...
    Sequence.prototype.isSequence = true;

    Sequence.prototype.mapPairs = function(f) {
      return this.enumerate().mapPairs(f);
    };

    Sequence.prototype.flatMapPairs = function(f) {
      return this.enumerate().flatMapPairs(f);
    };

    Sequence.prototype.take = function(x) {
    ...
    Sequence.prototype.join = function(joiner) {
    ...
    Sequence.prototype.scanl = function(memo, f) {
      return folds.scanl(this, memo, f);
    };

    Sequence.prototype.foldl = function(memo, f) {
