  ...
  mutators = {
    ...
    render: function(data, args) {
      ...
      result = function(dom, point) {
        ...
        return Varying.flatMapAll(_vendView, terminate(data).point(point), doPoint(args.context, point), doPoint(from.app(), point), doPoint(args.criteria, point), doPoint(args.options, point)).reactNow(function(view) {
          var ref1;
