(function() {
  ...
  Binder = (function(_super) {
    ...
    Binder.prototype.flatMap = function(transform) {
    ...
    Binder.prototype.apply = function() {
      ...
      return this._varying = new MultiVarying((function() {
        ...
        result = util.isFunction(_this._transform) ? _this._transform.apply(_this._model, values) : values.length === 1 ? values[0] : values;
        if (result == null) {
