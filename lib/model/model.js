(function() {
  ...
  Model = (function(_super) {
    ...
    Model.prototype.allAttributes = function() {
      var key, klass, _ref1, _results;

      _ref1 = this.constructor.allAttributes();
      _results = [];
      for (key in _ref1) {
        klass = _ref1[key];
        _results.push(new klass(this, key));
      }
      return _results;
    };
    ...
    Model.prototype.attrModified = function(path, deep) {
      var attribute, parentValue, transient, value, _ref1, _ref2;
      ...
      if (!transient) {
        ...
        if (value instanceof Model) {
          if (deep === true) {
            ...
            return parentValue !== value._parent;
          }
        } else {
    ...
    Model.prototype.watchModified = function(deep) {
      ...
      if (deep === true) {
        return (_ref1 = this._watchModifiedDeep$) != null ? _ref1 : this._watchModifiedDeep$ = (function() {
          ...
          result = new Varying(_this.modified());
          _this.on('anyChanged', function(path) {
            if (_this.attrModified(path)) {
              return result.setValue(true);
            } else {
              return result.setValue(_this.modified());
            }
          });
          watchModel = function(model) {
            return result.listenTo(model.watchModified(), 'changed', function(isChanged) {
              if (isChanged === true) {
                return result.setValue(true);
              } else {
                return result.setValue(_this.modified());
          ...
          uniqSubmodels.on('removed', function(oldModel) {
            return result.unlistenTo(oldModel.watchModified());
          });
          return result;
        })();
      } else {
        return (_ref2 = this._watchModified$) != null ? _ref2 : this._watchModified$ = (function() {
          ...
          result = new Varying(_this.modified(false));
          _this.on('anyChanged', function(path) {
            if (_this.attrModified(path, false)) {
              return result.setValue(true);
            } else {
              return result.setValue(_this.modified(false));
            }
          });
          return result;
        })();
    ...
    Model.prototype.original = function() {
      ...
      return (_ref1 = this._parent) != null ? _ref1 : this;
    };
