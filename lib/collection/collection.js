...
(function() {
  ...
  OrderedCollection = (function(superClass) {
    ...
    OrderedCollection.prototype.fold = function(memo, f) {
      return folds.fold(this, memo, f);
    };

    OrderedCollection.prototype.scanl = function(memo, f) {
      return folds.scanl(this, memo, f);
    };

    OrderedCollection.prototype.foldl = function(memo, f) {
      return folds.foldl(this, memo, f);
    };

    OrderedCollection.prototype.indexOf = function(value) {
