...
(function() {
  var Map, Model, Nothing, Varying, cases, deepGet, deepSet, isFunction, isString, match, otherwise, ref, ref1, ref2, types,
  ...
  Model = (function(superClass) {
    ...
    Model.prototype.get_ = function(key) {
      var attribute, value;
      value = Model.__super__.get_.call(this, key);
    ...
    Model.prototype.errors = function() {
      return this._errors$ != null ? this._errors$ : this._errors$ = this.validations().filter(types.validity.error.match).map(function(error) {
