(function() {
  ...
  Binder = (function(_super) {
    ...
    Binder.prototype.andVarying = Binder.prototype.from;

    Binder.prototype.transform = function(transform) {
      this._transform = transform;
      return this;
    };

    Binder.prototype.flatMap = Binder.prototype.transform;
    ...
    Binder.prototype.apply = function() {
      ...
      return this._varying = new MultiVarying((function() {
        ...
        result = util.isFunction(_this._transform) ? _this._transform.apply(_this, values) : values.length === 1 ? values[0] : values;
        if (result == null) {
