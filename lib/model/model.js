  ...
  Model = (function(superClass1) {
    ...
    Model.prototype.resolve = function(key, app) {
      ...
      if ((this.get(key) == null) && ((ref2 = (attribute = this.attribute(key))) != null ? ref2.isReference : void 0) === true) {
        result = new Varying(terminate(attribute.resolver()).point((function(_this) {
          return function(x) {
        ...
        varied = null;
        result.refCount().react((function(_this) {
          return function(count) {
            if (count === 1) {
              if (varied != null) {
                ...
                return varied = result.reactNow(function(x) {
    ...
    Model.prototype.resolveNow = function(key, app) {
      return this.resolve(key, app).reactNow(function(x) {
