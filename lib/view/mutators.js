  ...
  mutators = {
    ...
    render: function(data, args) {
      ...
      result = function(dom, point, immediate) {
        ...
        return getView(data.all.point(point), doPoint(args.context, point), doPoint(from.app(), point), doPoint(args.criteria, point), doPoint(args.options, point)).react(true, function(view) {
          var ref, runBefore;
