...
(function() {
  ...
  ref1 = require('./struct'), Null = ref1.Null, Struct = ref1.Struct;
  ...
  Model = (function(superClass1) {
    ...
    Model.serialize = function(model, opts) {
      ...
      walkAttrs = (function(_this) {
        return function(keys, src, target) {
          var attribute, innerResult, ref2, result, strKey, subKey, thisKey, value;
          for (subKey in src) {
            value = src[subKey];
            thisKey = keys.concat([subKey]);
            strKey = thisKey.join('.');
            attribute = model.attribute(strKey);
            result = value === Null ? void 0 : (attribute != null) && (attribute.serialize != null) ? attribute.serialize(opts) : util.isPlainObject(value) ? (innerResult = (ref2 = target[subKey]) != null ? ref2 : {}, walkAttrs(thisKey, value, innerResult), innerResult) : value;
