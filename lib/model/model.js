(function() {
  ...
  Model = (function(_super) {
    ...
    Model.prototype.get = function(key) {
      var attribute, value, _ref, _ref1;

      value = (_ref = util.deepGet(this.attributes, key)) != null ? _ref : (_ref1 = this._parent) != null ? _ref1.get(key) : void 0;
      if (value == null) {
    ...
    Model.serialize = function(model) {
      ...
      walkAttrs = function(keys, src, target) {
        var attribute, strKey, subKey, thisKey, value;
        ...
        for (subKey in src) {
          ...
          target[subKey] = (attribute != null) && (attribute.serialize != null) ? attribute.serialize() : util.isPlainObject(value) ? walkAttrs(thisKey, value, {}) : value;
        }
        return target;
      };
      result = {};
