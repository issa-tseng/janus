...
(function() {
  var ComposedVarying, FlatMappedVarying, FlattenedVarying, ManagedVarying, MappedVarying, Varied, Varying, fix, identity, isFunction, nothing, ref, uniqueId,
    slice = [].slice,
  ...
  FlatMappedVarying = (function(superClass) {
    ...
    _react = function(self, callback, immediate) {
      var id, ignoreFirst, initialGeneration, onValue, ref1, varied;
      id = uniqueId();
      self._observers[id] = varied = new Varied(id, callback, function() {
        ...
        self._refCount -= 1;
        if (self._refCount === 0) {
          if ((ref1 = self._lastInnerVaried) != null) {
            ref1.stop();
          }
          self._parentVaried.stop();
        }
        return (ref2 = self.refCount$) != null ? ref2.set(self._refCount) : void 0;
      });
      ignoreFirst = true;
      onValue = function(value) {
        var _, generation, o, ref1, ref2;
        if (self._flatten === true && this === self._parentVaried) {
          if ((ref1 = self._lastInnerVaried) != null) {
            ref1.stop();
          }
      ...
      self._refCount += 1;
      if ((ref1 = self.refCount$) != null) {
        ref1.set(self._refCount);
      }
      if ((self._generation === initialGeneration) && (self._flatten === true || immediate === true)) {
        if (self._lastValue === nothing) {
    ...
    FlatMappedVarying.prototype._bind = function(callback) {
      return this._parent.react((function(_this) {
        return function(raw) {
          return callback.call(_this._parentVaried, _this._f.call(null, raw));
        };
      })(this));
    };
  ...
  ComposedVarying = (function(superClass) {
    ...
    ComposedVarying.prototype._bind = function(callback) {
          ...
          results.push((function(_this) {
            return function(a, idx) {
              return a.reactNow(function(value) {
                ...
                if (allBound === true) {
                  callback.call(_this._parentVaried, _this._f.apply(_this._parentVarieds[idx], _this._partial));
                }
                return null;
              });
            };
      ...
      allBound = true;
      return new Varied(uniqueId(), null, (function(_this) {
        return function() {
          var i, len, ref1, results, v;
          ref1 = _this._parentVarieds;
          results = [];
  ...
  ManagedVarying = (function(superClass) {
    ...
    function ManagedVarying(_resources, _computation) {
      ...
      this._awake = false;
      resources = null;
      this.refCount().react((function(_this) {
