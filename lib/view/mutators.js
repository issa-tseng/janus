  ...
  mutators = {
    ...
    render: function(data, args) {
      ...
      result = function(dom, point) {
        ...
        _render = function(subject, context, app, find, options) {
          var view, _ref1;
          ...
          dom.empty();
          view = app.getView(subject, util.extendNew(find != null ? find : {}, {
            context: context,
        ...
        return Varying.pure(_render, terminate(data).point(point), doPoint(args.context), point('app'), doPoint(args.find), doPoint(args.options));
      };
