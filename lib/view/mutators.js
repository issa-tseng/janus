...
(function() {
  var Varying, doPoint, extendNew, from, isFunction, mutators, safe, terminate, _ref;

  Varying = require('../core/varying').Varying;

  from = require('../core/from');

  _ref = require('../util/util'), isFunction = _ref.isFunction, extendNew = _ref.extendNew;
  ...
  mutators = {
    ...
    render: function(data, args) {
      ...
      result = function(dom, point) {
        ...
        return Varying.flatMapAll(_getView, terminate(data).point(point), doPoint(args.context, point), doPoint(from.app(), point), doPoint(args.find, point), doPoint(args.options, point)).reactNow(function(view) {
          var _ref1;
