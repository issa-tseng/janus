...
(function() {
  var DerivedMap, Enumerable, Map, Nothing, NothingClass, Varying, deepDelete, deepGet, deepSet, isArray, isEmptyObject, isPlainObject, isString, ref, traverse, traverseAll,
  ...
  Map = (function(superClass) {
    ...
    Map.prototype.watchLength = function() {
      return this._watchLength$ != null ? this._watchLength$ : this._watchLength$ = Varying.managed(((function(_this) {
        return function() {
