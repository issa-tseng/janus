(function() {
  ...
  Binder = (function(_super) {
    ...
    Binder.prototype.unflat = function() {
      this._unflat = true;
      return this;
    };
    ...
    Binder.prototype.apply = function() {
      var data, fmap, setter, _ref1, _ref2,
        _this = this;
      ...
      fmap = (_ref2 = this._flatMap) != null ? _ref2 : fallbackMap;
      ...
      if (this._unflat === true) {
        return new MultiVarying(data, function() {
          var values;

          values = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
          return setter(fmap.apply(null, values));
        });
      } else {
        return new MultiVarying(data, fmap).map(setter);
      }
    };
