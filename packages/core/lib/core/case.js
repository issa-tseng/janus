...
(function() {
  var Case, Otherwise, capitalize, defaultOptions, defaultUnapplies, defcase, deftype, identity, isArray, isFunction, isPlainObject, isString, match, otherwise, ref, singleMatch,
  ...
  Case = (function() {
    ...
    Case.prototype.toString = function() {
      return "case[" + this.name + "]: " + (this.get());
    };
