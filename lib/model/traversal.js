...
(function() {
  var Traversal, cases, cases2, defcase, defer, delegate, extendNew, fn, from, get, identity, isFunction, isParentValueParent, k, kase, match, matcher, nothing, recurse, ref, ref1, ref2, value, varying, withContext, x,
    slice = [].slice;
  ...
  Traversal = {
    asList: function(obj, map, context, reduce) {
      ...
      return reduce(obj.enumeration().flatMapPairs(function(key, value) {
        var attribute, local;
        ...
        return matcher(map(key, value, obj, attribute, context), local);
      }));
    },
