(function() {
  ...
  ViewContainer = (function(_super) {
    ...
    ViewContainer.prototype._getView = function(subject) {
      ...
      if (subject instanceof Varying) {
        debugger;
      }
      view = subject instanceof DomView ? (this._subviews.add(subject), item) : this.options.itemView != null ? (result = new this.options.itemView(subject, util.extendNew(this.options.childOpts, {
