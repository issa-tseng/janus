(function() {
      ...
      next = function(idx) {
        return function(result) {
          if (result instanceof reference.RequestReference) {
            if (result.value instanceof reference.RequestResolver) {
              result.value.resolve(_this.parentBinder.options.app);
            }
            if (path[idx] != null) {
              return result.map(next(idx));
            } else {
              return result;
            }
          } else if (path[idx + 1] != null) {
  ...
  AttrMutator = (function(_super) {
    ...
    AttrMutator.prototype._apply = function(value) {
      return this.dom.attr(this.attr, util.isString(value) || util.isNumber(value) ? value : '');
    };
  ...
  CssMutator = (function(_super) {
    ...
    CssMutator.prototype._apply = function(value) {
      return this.dom.css(this.cssAttr, util.isString(value) || util.isNumber(value) ? value : '');
    };
  ...
  TextMutator = (function(_super) {
    ...
    TextMutator.prototype._apply = function(text) {
      return this.dom.text(util.isString(text) ? text : '');
    };
  ...
  HtmlMutator = (function(_super) {
    ...
    HtmlMutator.prototype._apply = function(html) {
      return this.dom.html(util.isString(html) ? html : '');
    };
  ...
  RenderMutator = (function(_super) {
    ...
    RenderMutator.prototype._viewFromResult = function(result) {
      ...
      if (result == null) {
        ...
        return new klass(result.model, (_ref8 = this.options) != null ? _ref8.constructorOpts : void 0);
