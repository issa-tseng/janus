...
(function() {
  var $, Base, DomView, EnumAttribute, EnumAttributeListEditView, List, ListSelectItemView, Varying, asList, find, from, identity, mutators, ref, template,
  ...
  EnumAttributeListEditView = DomView.build($('<div class="janus-enumSelect"/>'), template(find('div').render(from.self().flatMap(function(view) {
    return Varying.ly(view.subject.values()).map(asList);
