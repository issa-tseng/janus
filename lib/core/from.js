...
(function() {
  var Varying, applyMaps, build, conj, dc, defaultCases, defcase, from, ic, identity, immediate, internalCases, mappedPoint, match, matchFinal, otherwise, plainMap, terminus, val, _ref, _ref1,
    __slice = [].slice;

  Varying = require('./varying').Varying;

  _ref = require('./case'), defcase = _ref.defcase, match = _ref.match, otherwise = _ref.otherwise;
