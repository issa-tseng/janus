...
(function() {
  ...
  EnumAttributeEditView = (function(superClass) {
      ...
      Varying.ly(this.subject.values()).map(function(x) {
        ...
        return function(list) {
          ...
          _this._options = options = list.map(function(item) {
            ...
            option = $('<option/>');
            textBinding = Varying.ly(_this.options.stringify != null ? _this.options.stringify(item) : _this.subject.stringify != null ? _this.subject.stringify(item) : item == null ? '' : isPrimitive(item) ? item.toString() : item.toString != null ? item.toString() : item).reactNow(function(text) {
    ...
    EnumAttributeEditView.prototype._wireEvents = function() {
      ...
      subject.watchValue().reactNow((function(_this) {
        return function() {
