  ...
  Model = (function(superClass1) {
    ...
    Model.attributes = function() {
      ...
      if (this._attributesAgainst !== this) {
        ...
        return this._attributes = superClass.attributes != null ? superClass.attributes().shadow() : new Map();
      } else {
    ...
    Model["default"] = function(key, value, klass) {
      var wrapped;
      if (klass == null) {
        klass = require('./attribute').Attribute;
      }
      wrapped = util.isFunction(value) ? value : (function() {
        return value;
      });
      return this.attribute(key, (function(superClass2) {
    ...
    Model.transient = function(key) {
      return this.attributes().set(key, (function(superClass2) {
        extend(_Class, superClass2);
          ...
          for (i = 0, len = ref2.length; i < len; i++) {
            ...
            if (_this._binders[binder._key] == null) {
              (function(binder) {
                var key;
                key = binder._key;
                return _this._binders[key] = binder.all.point(function(x) {
