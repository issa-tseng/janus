    ...
    Model.serialize = function(model) {
      ...
      walkAttrs = function(keys, src, target) {
        ...
        for (subKey in src) {
          ...
          result = value === Null ? void 0 : (attribute != null) && (attribute.serialize != null) ? attribute.serialize() : util.isPlainObject(value) ? (result = {}, walkAttrs(thisKey, value, result), util.hasProperties(result) ? result : void 0) : value;
      ...
      result = model._parent != null ? this.serialize(model._parent) : {};
