(function() {
  ...
  Model = (function(_super) {
    ...
    Model.prototype.get = function(key) {
      var value, _ref, _ref1, _ref2;

      value = (_ref = (_ref1 = util.deepGet(this.attributes, key)) != null ? _ref1 : (_ref2 = this._parent) != null ? _ref2.get(key) : void 0) != null ? _ref : null;
      if (value === Null) {
        return null;
      } else {
        return value;
    ...
    Model.prototype.attribute = function(key) {
      return new (this.constructor.attributes()[key])(this, key);
    };
