...
(function() {
  var Base, DerivedStruct, Null, NullClass, Struct, Traversal$, Varying, deepDelete, deepGet, deepSet, extendNew, isArray, isEmptyObject, isPlainObject, ref, traverse, traverseAll,
  ...
  Struct = (function(superClass) {
    ...
    Struct.prototype.isEnumerable = true;

    Struct.prototype.isStruct = true;

    function Struct(attributes, options1) {
      if (attributes == null) {
        attributes = {};
      }
    ...
    Struct.prototype.enumeration = function(options) {
      return require('./enumeration').Enumeration.struct.watch(this, options);
    };

    Struct.prototype.enumerate = function(options) {
      return require('./enumeration').Enumeration.struct.get(this, options);
    };

    Struct.prototype.watchLength = function() {
      return this.watchLength$ != null ? this.watchLength$ : this.watchLength$ = this.enumeration().watchLength();
    };
    ...
    Struct.prototype.watchModified = function() {
      if (this._parent != null) {
    ...
    Struct.prototype.watchDiff = function(other) {
      if ((other != null) && other.isStruct === true && other.isCollection !== true) {
