...
(function() {
  ...
  val = function(conjunction, applicants) {
    ...
    result.pipe = function(f) {
      var i, last, rest;
      rest = 2 <= applicants.length ? slice.call(applicants, 0, i = applicants.length - 1) : (i = 0, []), last = applicants[i++];
      return val(conjunction, conj(rest, internalCases.pipe({
        inner: last,
        f: f
      })));
    };
  ...
  mappedPoint = match(ic.map(function(arg, point) {
    var f, inner;
    inner = arg.inner, f = arg.f;
  ...
  }), ic.resolve(function(arg, point) {
    var attr, inner;
    inner = arg.inner, attr = arg.attr;
    return match(ic.varying(function(x) {
