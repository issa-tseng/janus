...
(function() {
  var Traversal, Varying, deepSet, defer, delegate, identity, isFunction, match, matcher, nothing, otherwise, prematcher, preprocess, processNode, recurse, reducer, ref, ref1, ref2, value, varying;

  Varying = require('../core/varying').Varying;

  ref = require('../util/util'), identity = ref.identity, isFunction = ref.isFunction, deepSet = ref.deepSet;
  ...
  matcher = match(recurse(function(into, context, local) {
    ...
    return matcher(to(local.key, local.value, local.obj, local.attribute, context != null ? context : local.context), Object.assign({}, local, {
      context: context
    }));
