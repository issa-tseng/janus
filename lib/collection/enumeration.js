...
(function() {
  var DerivedList, Enumeration, IndexList, KeyList, Struct, Varying, _dynamic, deepGet, ref, traverse, traverseAll,
  ...
  IndexList = (function(superClass) {
    ...
    function IndexList(parent) {
      ...
      this._lengthVaried = this.parent.watchLength().reactNow((function(_this) {
    ...
    IndexList.prototype.destroy = function() {
      this._lengthVaried.stop();
      return IndexList.__super__.destroy.call(this);
    };
  ...
  _dynamic = function(f) {
    return function(obj, options) {
      return Enumeration[obj.isCollection === true ? 'list' : obj.isStruct === true ? 'struct' : void 0][f](obj, options);
    };
  };
