...
(function() {
  var capitalize, defcase, isArray, isFunction, isPlainObject, match, otherwise, ref, unapply,
    slice = [].slice;

  ref = require('../util/util'), capitalize = ref.capitalize, isPlainObject = ref.isPlainObject, isFunction = ref.isFunction, isArray = ref.isArray;
