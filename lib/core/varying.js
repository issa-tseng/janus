(function() {
  var ComposedVarying, FlatMappedVarying, FlattenedVarying, MappedVarying, Varied, Varying, fix, identity, isFunction, uniqueId, _ref,
    __slice = [].slice,
  ...
  FlatMappedVarying = (function(_super) {
    ...
    FlatMappedVarying.prototype.react = function(callback) {
      var id, lastInnerVaried, lastValue, onValue, parentVaried, self, varied,
        _this = this;
    ...
    FlatMappedVarying.prototype._bind = function(callback) {
      ...
      return varied = this._parent.react(function(x) {
        return callback.call(varied, _this._f.call(null, x));
      });
    };
  ...
  ComposedVarying = (function(_super) {
        ...
        this._parentVarieds = (function() {
          ...
          for (idx = _i = 0, _len = _ref1.length; _i < _len; idx = ++_i) {
            ...
            _results.push((function(a, idx) {
              return a.reactNow(function() {
                var o, _j, _len1, _ref2, _results1;

                _this._partial[idx] = a;
                _ref2 = _this._observers;
                _results1 = [];
                for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
                  o = _ref2[_j];
                  _results1.push(o.f_(_this._partial));
                }
                return _results1;
              });
            })(a, idx));
    ...
    ComposedVarying.prototype.get = function() {
      var a, result;
