...
(function() {
  ...
  Library = (function(superClass1) {
    ...
    Library.prototype.get = function(obj, options) {
      ...
      result = (ref = this._get(obj, obj != null ? obj.constructor : void 0, (ref1 = options.context) != null ? ref1 : this._defaultContext, options)) != null ? ref : this._get(obj, obj != null ? obj.constructor : void 0, 'default', options);
      if (result != null) {
    ...
    Library.prototype._get = function(obj, klass, context, options) {
      var bookId, contextShelf, i, len, record, ref, superClass;
      bookId = obj == null ? 'null' : obj.isCaseInstance === true ? "case@" + obj["case"].namespace + "." + obj.type : obj.isCase === true ? "case@" + obj.namespace + "." + obj.type : util.isNumber(obj) ? 'number' : util.isString(obj) ? 'string' : obj === true || obj === false ? 'boolean' : Library._classId(klass);
      ...
      if (klass != null) {
        ...
        if (superClass != null) {
          return this._get(obj, superClass, context, options);
        }
      }
    };
    ...
    Library._classId = function(klass) {
      ...
      if (klass == null) {
        return 'null';
      } else if (klass.isCaseInstance === true) {
