(function() {
  ...
  Varying = (function(_super) {
    ...
    Varying.prototype.extract = function(f, opts) {
      return this.react(function(changedVal) {
        return changedVal != null ? typeof changedVal.extract === "function" ? changedVal.extract(f, opts) : void 0 : void 0;
      });
    };
    ...
    Varying.lie = {
      ...
      ignoreNull: function(source) {
        var result;

        result = new Varying(source.value);
        result._parent = source;
        source.react(function(newValue) {
          if (newValue != null) {
            return result.setValue(newValue);
          }
        });
      ...
      throttle: function(source, delay) {
        var pending, result, set, timer;
      ...
      debounce: function(source, delay) {
        var result, timer;
      ...
      freeze: function(source, gate) {
        ...
        gate.on('changed', function(gated) {
          if (gated !== true) {
            return result.setValue(source.value);
          }
        });
