...
(function() {
  ...
  View = (function(superClass) {
    ...
    View.point = match(dynamic(function(x, view) {
      if (isFunction(x)) {
        return Varying.of(x(view.subject));
      } else if (isString(x) && (view.subject.watch != null)) {
      ...
      if (x != null) {
        return view.options.app.watch(x);
      } else {
        return new Varying(view.options.app);
      }
    }), self(function(x, view) {
      if (isFunction(x)) {
        return Varying.of(x(view));
      } else {
        return Varying.of(view);
      }
    }));
