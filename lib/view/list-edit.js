...
(function() {
  ...
  moveHandler = function(direction) {
    return function(event, subject, view, dom) {
  ...
  ListEditItemView = (function(superClass) {
    ...
    _Class.prototype.attach = function(dom) {
      this._artifact = dom;
    ...
    _Class.prototype._wireEvents = function() {
      return this.artifact().closest('li').on('janus-itemMoved', (function(_this) {
  ...
  })(DomView.build($('<div class="janus-list-editItem"> <a class="janus-list-editItem-moveUp">Move Up</a> <a class="janus-list-editItem-moveDown">Move Down</a> <a class="janus-list-editItem-remove">Remove</a> <div class="janus-list-editItem-dragHandle"></div> <div class="janus-list-editItem-contents"></div> </div>'), template(find('.janus-list-editItem-moveUp').classed('disabled', from.self().flatMap(function(view) {
