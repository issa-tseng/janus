(function() {
  ...
  Binder = (function(_super) {
    ...
    Binder.prototype.find = function(selector) {
      var _base;
      return (_base = this._children)[selector] != null ? (_base = this._children)[selector] : _base[selector] = new Binder(this.dom.find(selector), util.extendNew(this.options, {
        parent: this
      }));
    };
    ...
    Binder.prototype._attachMutator = function(klass, param) {
      var existingMutator, identity, mutator, _base, _name;
      identity = klass.identity(param);
      existingMutator = ((_base = this._mutatorIndex)[_name = klass.name] != null ? (_base = this._mutatorIndex)[_name = klass.name] : _base[_name] = {})[identity];
  ...
  Mutator = (function(_super) {
    ...
    Mutator.prototype.fromVarying = function(varyingGenerator) {
      ...
      this._data.push(function(primary, aux) {
        return varyingGenerator.call(_this, primary, aux);
      });
      return this;
    };
