(function() {
  var ApplyMutator, AttrMutator, Base, Binder, ClassGroupMutator, ClassMutator, CssMutator, HtmlMutator, MultiVarying, Mutator, RenderMutator, RenderWithMutator, TextMutator, Varying, traverseFrom, util, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  RenderMutator = (function(_super) {
    ...
    RenderMutator.prototype._apply = function(model) {
      var subView;
      ...
      if (model != null) {
        ...
        return this.dom.append(subView.artifact());
      }
    };
