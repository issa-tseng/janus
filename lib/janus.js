(function() {
  var janus, util, _base;

  util = require('./util/util');

  janus = (_base = typeof window !== "undefined" && window !== null ? window : global)._janus$ != null ? (_base = typeof window !== "undefined" && window !== null ? window : global)._janus$ : _base._janus$ = {
    util: util,
