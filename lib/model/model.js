...
(function() {
  ...
  Model = (function(superClass) {
    ...
    Model.point = match(cases.dynamic(function(x, self) {
    ...
    }), cases.watch(function(x, self) {
      return self.watch(x);
    }), cases.attribute(function(x, self) {
      return new Varying(self.attribute(x));
    }), cases.varying(function(x, self) {
      if (util.isFunction(x)) {
        return Varying.of(x(self));
      } else {
        return Varying.of(x);
      }
    }), cases.app(function(x, self, app) {
      if (app == null) {
    ...
    Model.prototype.validations = function() {
      return this._validations$ != null ? this._validations$ : this._validations$ = (function(_this) {
        return function() {
          ...
          return new List(_this.constructor.schema.validations).flatMap(function(binding) {
    ...
    Model.prototype.issues = function() {
      return this._issues$ != null ? this._issues$ : this._issues$ = this.validations().filter(types.validity.invalid.match);
    };
