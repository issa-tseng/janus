...
(function() {
  ...
  apply = [
    noop, noop, function(f, x) {
      ...
      f = x[5];
      return function() {
        return f(a._value, b._value, c._value, d._value, e._value, f._value);
      };
    }, function(f, x) {
      var a, b, c, d, e, g;
      a = x[0];
      ...
      g = x[6];
      return function() {
        return f(a._value, b._value, c._value, d._value, e._value, f._value, g._value);
      };
    }, function(f, x) {
      var a, b, c, d, e, g, h;
      a = x[0];
      ...
      h = x[7];
      return function() {
        return f(a._value, b._value, c._value, d._value, e._value, f._value, g._value, h._value);
      };
    }, function(f, x) {
      var a, b, c, d, e, g, h, i;
      a = x[0];
      ...
      i = x[8];
      return function() {
        return f(a._value, b._value, c._value, d._value, e._value, f._value, g._value, h._value, i._value);
      };
    }
  ];
  ...
  Varying = (function() {
    ...
    Varying.managed = function() {
      var computation, j, resources;
      resources = 2 <= arguments.length ? slice.call(arguments, 0, j = arguments.length - 1) : (j = 0, []), computation = arguments[j++];
    ...
    function DerivedVarying(applicants, _f, _flatten) {
      ...
      this._apply = length === 1 ? (first = this.a[0], function() {
        ...
        return _f.apply(null, (function() {
          var j, len, results;
          results = [];
          for (j = 0, len = applicants.length; j < len; j++) {
            a = applicants[j];
  ...
  ManagedVarying = (function(superClass) {
    ...
    ManagedVarying.prototype.get = function() {
      var f, j, len, resource, resources, result;
      if (this._awake === true) {
