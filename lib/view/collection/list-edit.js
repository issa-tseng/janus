(function() {
  var DomView, ListEditItem, ListEditItemTemplate, ListEditView, ListView, Templater, util, _ref, _ref1, _ref2,
  ...
  ListEditView = (function(_super) {
    ...
    ListEditView.prototype._initialize = function() {
      ...
      return (_ref1 = (_base = this.options).itemContext) != null ? _ref1 : _base.itemContext = 'edit-wrapper';
    };
  ...
  ListEditItemTemplate = (function(_super) {
    ...
    ListEditItemTemplate.prototype._binding = function() {
      ...
      binding.find('.editItem').render(this.options.app, {
        context: (_ref2 = this.options.context) != null ? _ref2 : 'edit'
      }).fromSelf();
      return binding;
    };
