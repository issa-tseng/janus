        ...
        if (obj._parent == null) {
          ...
          return varying(watch(obj._parent, k).map(function(vb) {
            ...
            if ((va != null ? va.isEnumerable : void 0) === true) {
              if (vb === va._parent) {
                vla = va.isCollection === true ? va.watchLength() : va.enumeration().watchLength();
                vlb = vb.isCollection === true ? vb.watchLength() : vb.enumeration().watchLength();
                return varying(Varying.mapAll(vla, vlb, function(la, lb) {
                  if (la !== lb) {
                    return value(true);
                  } else {
                    return recurse(va);
