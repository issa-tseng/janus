...
(function() {
  ...
  KeyList = (function(superClass) {
    ...
    function KeyList(target, options) {
      ...
      this.listenTo(this.target, 'anyChanged', (function(_this) {
    ...
    KeyList.prototype.mapPairs = function(f) {
      return this.flatMap((function(_this) {
        return function(key) {
          return Varying.mapAll(f, new Varying(key), _this.target.watch(key));
        };
      })(this));
    };
    ...
    KeyList.prototype.flatMapPairs = function(f) {
      return this.flatMap((function(_this) {
        return function(key) {
          return Varying.flatMapAll(f, new Varying(key), _this.target.watch(key));
        };
      })(this));
    };
  ...
  IndexList = (function(superClass) {
    ...
    function IndexList(parent) {
      ...
      this._lengthObservation = this.reactTo(this.parent.watchLength(), (function(_this) {
  ...
  _dynamic = function(f) {
    return function(obj, options) {
      return Enumeration[obj.isMappable === true ? 'list' : obj.isMap === true ? 'map' : void 0][f](obj, options);
    };
  };
