(function() {
  var Base, List, Model, OrderedIncrementalList, util,
  ...
  List = (function(_super) {
    ...
    List.prototype.shadow = function() {
      ...
      return new List(newArray, util.extendNew(this.options, {
        parent: this
      }));
    };
    ...
    List.deserialize = function(data) {
      ...
      items = (function() {
        ...
        if ((this.modelClass != null) && this.modelClass.prototype instanceof Model) {
          _results = [];
